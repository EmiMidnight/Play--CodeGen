...
CCodeGen_AArch64::CONSTMATCHER CCodeGen_AArch64::g_constMatchers[] =
{
	...
	{ OP_LOAD8FROMREF,   MATCH_VARIABLE,       MATCH_VAR_REF,        MATCH_ANY32,         MATCH_NIL,      &CCodeGen_AArch64::Emit_Load8FromRef_MemVarAny              },
	
	{ OP_LOAD16FROMREF,  MATCH_VARIABLE,       MATCH_VAR_REF,        MATCH_NIL,           MATCH_NIL,      &CCodeGen_AArch64::Emit_Load16FromRef_MemVar                },
	{ OP_LOAD16FROMREF,  MATCH_VARIABLE,       MATCH_VAR_REF,        MATCH_ANY32,         MATCH_NIL,      &CCodeGen_AArch64::Emit_Load16FromRef_MemVarAny             },

	{ OP_STOREATREF,     MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY32,         MATCH_NIL,      &CCodeGen_AArch64::Emit_StoreAtRef_VarAny                   },
	{ OP_STOREATREF,     MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY32,         MATCH_ANY32,    &CCodeGen_AArch64::Emit_StoreAtRef_VarAnyAny                },

	{ OP_STORE8ATREF,    MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY,           MATCH_NIL,      &CCodeGen_AArch64::Emit_Store8AtRef_VarAny                  },
	{ OP_STORE8ATREF,    MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY,           MATCH_ANY,      &CCodeGen_AArch64::Emit_Store8AtRef_VarAnyAny               },
	
	{ OP_STORE16ATREF,   MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY,           MATCH_NIL,      &CCodeGen_AArch64::Emit_Store16AtRef_VarAny                 },
	{ OP_STORE16ATREF,   MATCH_NIL,            MATCH_VAR_REF,        MATCH_ANY,           MATCH_ANY,      &CCodeGen_AArch64::Emit_Store16AtRef_VarAnyAny              },
	...
	{ OP_CMPSELECT_P1,   MATCH_NIL,            MATCH_ANY,            MATCH_VARIABLE,      MATCH_NIL,      &CCodeGen_AArch64::Emit_CmpSelectP1_AnyVar                  },
	{ OP_CMPSELECT_P2,   MATCH_VARIABLE,       MATCH_ANY,            MATCH_ANY,           MATCH_NIL,      &CCodeGen_AArch64::Emit_CmpSelectP2_VarAnyAny               },
...
void CCodeGen_AArch64::Emit_Load8FromRef_MemVarAny(const STATEMENT& statement)
{
	auto dst = statement.dst->GetSymbol();
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
	...
	{
		auto indexReg = PrepareSymbolRegisterUse(src2, GetNextTempRegister());
		m_assembler.Ldrb(valueReg, addressReg, static_cast<CAArch64Assembler::REGISTER64>(indexReg), (scale == 1));
	}
...
void CCodeGen_AArch64::Emit_Load16FromRef_MemVarAny(const STATEMENT& statement)
{
	auto dst = statement.dst->GetSymbol();
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
	...
	{
		auto indexReg = PrepareSymbolRegisterUse(src2, GetNextTempRegister());
		m_assembler.Ldrh(valueReg, addressReg, static_cast<CAArch64Assembler::REGISTER64>(indexReg), false);
	}
...
void CCodeGen_AArch64::Emit_StoreAtRef_VarAnyAny(const STATEMENT& statement)
{
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
...
void CCodeGen_AArch64::Emit_Store8AtRef_VarAnyAny(const STATEMENT& statement)
{
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
	auto src3 = statement.src3->GetSymbol();
	...
	{
		auto indexReg = PrepareSymbolRegisterUse(src2, GetNextTempRegister());
		m_assembler.Strb(valueReg, addressReg, static_cast<CAArch64Assembler::REGISTER64>(indexReg), (scale == 1));
	}
}
...
void CCodeGen_AArch64::Emit_Store16AtRef_VarAnyAny(const STATEMENT& statement)
{
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
	auto src3 = statement.src3->GetSymbol();
	...
	{
		auto indexReg = PrepareSymbolRegisterUse(src2, GetNextTempRegister());
		m_assembler.Strh(valueReg, addressReg, static_cast<CAArch64Assembler::REGISTER64>(indexReg), (scale == 2));
	}
}
...
void CCodeGen_AArch64::Emit_CmpSelectP1_AnyVar(const STATEMENT& statement)
{
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
...
void CCodeGen_AArch64::Emit_CmpSelectP2_VarAnyAny(const STATEMENT& statement)
{
	auto dst = statement.dst->GetSymbol();
	auto src1 = statement.src1->GetSymbol();
	auto src2 = statement.src2->GetSymbol();
