...
#define ALU_CONST_MATCHERS(ALUOP_CST, ALUOP) \
	...
	{ ALUOP_CST, MATCH_REGISTER, MATCH_REGISTER, MATCH_CONSTANT, MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegRegCst<ALUOP> }, \
	{ ALUOP_CST, MATCH_REGISTER, MATCH_MEMORY,   MATCH_REGISTER, MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegMemReg<ALUOP> }, \
	{ ALUOP_CST, MATCH_REGISTER, MATCH_MEMORY,   MATCH_MEMORY,   MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegMemMem<ALUOP> }, \
	{ ALUOP_CST, MATCH_REGISTER, MATCH_MEMORY,   MATCH_CONSTANT, MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegMemCst<ALUOP> }, \
	{ ALUOP_CST, MATCH_REGISTER, MATCH_CONSTANT, MATCH_REGISTER, MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegCstReg<ALUOP> }, \
	{ ALUOP_CST, MATCH_REGISTER, MATCH_CONSTANT, MATCH_MEMORY,   MATCH_NIL, &CCodeGen_x86::Emit_Alu_RegCstMem<ALUOP> }, \
\
	{ ALUOP_CST, MATCH_MEMORY, MATCH_REGISTER, MATCH_REGISTER,   MATCH_NIL, &CCodeGen_x86::Emit_Alu_MemRegReg<ALUOP> }, \
	{ ALUOP_CST, MATCH_MEMORY, MATCH_REGISTER, MATCH_MEMORY,     MATCH_NIL, &CCodeGen_x86::Emit_Alu_MemRegMem<ALUOP> }, \
	{ ALUOP_CST, MATCH_MEMORY, MATCH_REGISTER, MATCH_CONSTANT,   MATCH_NIL, &CCodeGen_x86::Emit_Alu_MemRegCst<ALUOP> }, \
	{ ALUOP_CST, MATCH_MEMORY, MATCH_MEMORY,   MATCH_REGISTER,   MATCH_NIL, &CCodeGen_x86::Emit_Alu_MemMemReg<ALUOP> }, \
